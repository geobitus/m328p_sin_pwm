...
spwm.elf:     file format elf32-avr
...
00800100 <HW_ARRAY>:
  800100:	00 00       	nop
  800102:	3a 01       	movw	r6, r20
  800104:	72 02       	muls	r23, r18
  800106:	a6 03       	fmuls	r18, r22
  800108:	d4 04       	cpc	r13, r4
  80010a:	fb 05       	cpc	r31, r11
  80010c:	18 07       	cpc	r17, r24
  80010e:	2a 08       	sbc	r2, r10
  800110:	2f 09       	sbc	r18, r15
  800112:	26 0a       	sbc	r2, r22
  800114:	0c 0b       	sbc	r16, r28
  800116:	e2 0b       	sbc	r30, r18
  800118:	a4 0c       	add	r10, r4
  80011a:	53 0d       	add	r21, r3
  80011c:	ec 0d       	add	r30, r12
  80011e:	70 0e       	add	r7, r16
  800120:	dc 0e       	add	r13, r28
  800122:	31 0f       	add	r19, r17
  800124:	6f 0f       	add	r22, r31
  800126:	94 0f       	add	r25, r20
  800128:	a0 0f       	add	r26, r16
  80012a:	94 0f       	add	r25, r20
  80012c:	6f 0f       	add	r22, r31
  80012e:	31 0f       	add	r19, r17
  800130:	dc 0e       	add	r13, r28
  800132:	70 0e       	add	r7, r16
  800134:	ec 0d       	add	r30, r12
  800136:	53 0d       	add	r21, r3
  800138:	a4 0c       	add	r10, r4
  80013a:	e2 0b       	sbc	r30, r18
  80013c:	0c 0b       	sbc	r16, r28
  80013e:	26 0a       	sbc	r2, r22
  800140:	2f 09       	sbc	r18, r15
  800142:	2a 08       	sbc	r2, r10
  800144:	18 07       	cpc	r17, r24
  800146:	fb 05       	cpc	r31, r11
  800148:	d4 04       	cpc	r13, r4
  80014a:	a6 03       	fmuls	r18, r22
  80014c:	72 02       	muls	r23, r18
  80014e:	3a 01       	movw	r6, r20

00800150 <POINTER_MAX>:
  800150:	28 a0       	ldd	r2, Y+32	; 0x20

00800151 <MCCPP>:
  800151:	a0 0f       	add	r26, r16
	...
...
000000a6 <reg_init>:
  ...
  d6:	18 82       	st	Y, r1
  d8:	88 81       	ld	r24, Y
  da:	82 6c       	ori	r24, 0xC2	; 194
  dc:	88 83       	st	Y, r24
  de:	8c 91       	ld	r24, X
  e0:	89 61       	ori	r24, 0x19	; 25
  e2:	8c 93       	st	X, r24
  e4:	80 81       	ld	r24, Z
 ...
 104:	80 91 51 01 	lds	r24, 0x0151	; 0x800151 <MCCPP>
 108:	90 91 52 01 	lds	r25, 0x0152	; 0x800152 <MCCPP+0x1>
...
00000118 <__vector_13>:
 ...
 120:	11 24       	eor	r1, r1
 122:	f8 94       	cli
 124:	80 91 55 01 	lds	r24, 0x0155	; 0x800155 <__bss_end>
 128:	88 23       	and	r24, r24
 12a:	41 f0       	breq	.+16     	; 0x13c <__vector_13+0x24>
 12c:	80 91 80 00 	lds	r24, 0x0080	; 0x800080 <__TEXT_REGION_LENGTH__+0x7f8080>
 130:	90 ef       	ldi	r25, 0xF0	; 240
 132:	89 27       	eor	r24, r25
 134:	80 93 80 00 	sts	0x0080, r24	; 0x800080 <__TEXT_REGION_LENGTH__+0x7f8080>
 138:	10 92 55 01 	sts	0x0155, r1	; 0x800155 <__bss_end>
 13c:	90 91 54 01 	lds	r25, 0x0154	; 0x800154 <__data_end>
 140:	80 91 50 01 	lds	r24, 0x0150	; 0x800150 <POINTER_MAX>
 144:	98 17       	cp	r25, r24
 146:	28 f0       	brcs	.+10     	; 0x152 <__vector_13+0x3a>
 148:	10 92 54 01 	sts	0x0154, r1	; 0x800154 <__data_end>
 14c:	81 e0       	ldi	r24, 0x01	; 1
 14e:	80 93 55 01 	sts	0x0155, r24	; 0x800155 <__bss_end>
 152:	80 91 54 01 	lds	r24, 0x0154	; 0x800154 <__data_end>
 ...
 166:	30 93 8b 00 	sts	0x008B, r19	; 0x80008b <__TEXT_REGION_LENGTH__+0x7f808b>
 16a:	20 93 8a 00 	sts	0x008A, r18	; 0x80008a <__TEXT_REGION_LENGTH__+0x7f808a>
 16e:	30 93 89 00 	sts	0x0089, r19	; 0x800089 <__TEXT_REGION_LENGTH__+0x7f8089>
 172:	20 93 88 00 	sts	0x0088, r18	; 0x800088 <__TEXT_REGION_LENGTH__+0x7f8088>
 176:	8f 5f       	subi	r24, 0xFF	; 255
 178:	80 93 54 01 	sts	0x0154, r24	; 0x800154 <__data_end>
 17c:	78 94       	sei
 17e:	0f 90       	pop	r0
...
000001b6 <main>:
 1b6:	0e 94 53 00 	call	0xa6	; 0xa6 <reg_init>
 1ba:	ff cf       	rjmp	.-2      	; 0x1ba <main+0x4>
...
00000000 <_end-0x800155>:
   0:	47 43       	sbci	r20, 0x37	; 55
   2:	43 3a       	cpi	r20, 0xA3	; 163
   4:	20 28       	or	r2, r0
   6:	41 56       	subi	r20, 0x61	; 97
   8:	52 5f       	subi	r21, 0xF2	; 242
   a:	38 5f       	subi	r19, 0xF8	; 248
   c:	62 69       	ori	r22, 0x92	; 146
   e:	74 5f       	subi	r23, 0xF4	; 244
  10:	47 4e       	sbci	r20, 0xE7	; 231
  12:	55 5f       	subi	r21, 0xF5	; 245
  14:	54 6f       	ori	r21, 0xF4	; 244
  16:	6f 6c       	ori	r22, 0xCF	; 207
  18:	63 68       	ori	r22, 0x83	; 131
  1a:	61 69       	ori	r22, 0x91	; 145
  1c:	6e 5f       	subi	r22, 0xFE	; 254
  1e:	33 2e       	mov	r3, r19
  20:	37 2e       	mov	r3, r23
  22:	30 5f       	subi	r19, 0xF0	; 240
  24:	31 37       	cpi	r19, 0x71	; 113
  26:	39 36       	cpi	r19, 0x69	; 105
  28:	29 20       	and	r2, r9
  2a:	37 2e       	mov	r3, r23
  2c:	33 2e       	mov	r3, r19
...
00000000 <.debug_info>:
  ...
  6e:	00 00       	nop
  70:	01 05       	cpc	r16, r1
  72:	03 c1       	rjmp	.+518    	; 0x27a <__data_load_end+0x66>
  74:	00 80       	ld	r0, Z
  76:	00 0a       	sbc	r0, r16
  ...
  80:	00 00       	nop
  82:	01 05       	cpc	r16, r1
  84:	03 c2       	rjmp	.+1030   	; 0x48c <__EEPROM_REGION_LENGTH__+0x8c>
  86:	00 80       	ld	r0, Z
